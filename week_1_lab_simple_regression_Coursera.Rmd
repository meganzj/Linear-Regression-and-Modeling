...
since residual is negative, the least squares line overestimate the y
</div>
...
b0 = coef(summary(m1))["(Intercept)","Estimate"]
b1 = coef(summary(m1))["at_bats","Estimate"]
x = 5579
y_hat = b0 + b1 * x
y_hat
y_observe = 713
...
for certain ranges of fitted values the residuals tend to be all positive or all negative, this could indicate a cyclical or wave-like pattern in the residuals, which is a sign of non-linearity
</div>
```{r diag}
# type your code for the Exercise here, and Knit
# check randomly distributted residuals
